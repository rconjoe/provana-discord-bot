...
module.exports = {
  default: async (bot, interaction) => {
    if (interaction.customId === 'chooseIssue') {
      ...
      const start = dayjs(new Date(_start)).tz('America/New_York')
